...
const AttendanceWidget = () => {
  ...
  return (
    <Card className="relative overflow-hidden">
      ...
      <div className="text-center mb-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4">
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4 border border-green-100">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-xs text-green-600 font-medium uppercase tracking-wide">Working Time</div>
              <div className="text-xl font-bold text-green-700 font-mono mt-1">
        ...
        <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-4 border border-amber-100">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-xs text-amber-600 font-medium uppercase tracking-wide">Break Time</div>
      ...
      <div className="space-y-2">
        ...
        {status.currentState === 'checked_out' && (
          <div className="text-center py-4 bg-gray-50 rounded-lg">
            ...
            <p className="text-gray-600 font-medium">Already checked out for today</p>
            <p className="text-sm text-gray-500">Total: {formatTime(status.totalWorkingMinutes * 60)}</p>
          </div>
        )}
      </div>
