  ...
  return (
    <header className="sticky top-0 z-20 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
      <div className="flex items-center justify-between h-16 px-4 lg:px-6">
        ...
        {/* Right side - Search, Location, Theme Toggle, Notifications, Profile */}
        <div className="flex items-center gap-2 lg:gap-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <svg className="w-4 h-4 hidden md:block text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
