...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const navigation = [
    ...
    { name: 'Leaves', href: '/leaves', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
    { name: 'Onboarding', href: '/onboarding', icon: 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z', adminOnly: true },
  ...
  const filteredNavigation = navigation.filter(
    (item) => !item.adminOnly || (item.adminOnly && isAdminOrHR())
  );
